...
const Endcard = ({ title,location }) => {
  return (
    <div className="p-10 font-poppins bg-orange-500 m-2 rounded-3xl text-white md:flex justify-evenly items-center">
      <h1 className="md:text-5xl text-2xl mb-10 md:mb-0">{title}</h1>
